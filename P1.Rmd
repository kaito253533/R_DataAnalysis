...
q1 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet1.csv")
q2 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet2.csv")
q3 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet3.csv")
q4 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet4.csv")
...
```{r}
rent <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/archive/rent.csv")
```
...
library(ggplot2)
library(reshape2)
q1 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet1.csv", col.names = c("x", "y", "A"))
q2 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet2.csv", col.names = c("x", "y", "B"))
q3 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet3.csv", col.names = c("x", "y", "C"))
q4 <- read.csv("/Users/lexi/Documents/QUT/S1/IFN 509/quartet_data/quartet4.csv", col.names = c("x", "y", "D"))
